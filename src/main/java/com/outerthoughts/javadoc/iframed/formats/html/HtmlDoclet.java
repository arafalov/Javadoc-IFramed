...
import com.outerthoughts.javadoc.iframed.internal.toolkit.AbstractDoclet;
import com.outerthoughts.javadoc.iframed.internal.toolkit.Configuration;
import com.outerthoughts.javadoc.iframed.internal.toolkit.builders.AbstractBuilder;
...
public class HtmlDoclet extends AbstractDoclet {
    ...
    protected void generateOtherFiles(RootDoc root, ClassTree classtree)
        ...
        f = DocFile.createFileForOutput(configuration, DocPaths.STYLESHEET_SELECT2);
        f.copyResource(DocPaths.RESOURCES.resolve(DocPaths.STYLESHEET_SELECT2), false, true);

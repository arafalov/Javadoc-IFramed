...
import com.outerthoughts.javadoc.iframed.internal.toolkit.taglets.DocRootTaglet;
import com.outerthoughts.javadoc.iframed.internal.toolkit.taglets.TagletWriter;
    ...
    public Content getAnalytics() {
        String scriptCode =
                "(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){\n" +
                        ...
                        "ga('create', '" +
                        configuration.getResource("ga.code") +
                        "', '" +
                        configuration.getResource("ga.domain") +
                        "');\n" +
                        "ga('send', 'pageview');"
                ;
        Content scriptContent = new RawHtml(scriptCode);

        HtmlTree ga = new HtmlTree(HtmlTag.SCRIPT);
        ga.addAttr(HtmlAttr.TYPE, "text/javascript");
        ga.addContent(scriptContent);

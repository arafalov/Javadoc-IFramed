 ...
 * are used by the Sub-Classes in the package com.outerthoughts.javadoc.iframed.standard
 * and com.outerthoughts.javadoc.iframed.oneone.
 *
...
public abstract class HtmlDocWriter extends HtmlWriter {
    ...
    protected Comment getGeneratedBy(boolean timestamp) {
        String text = "Generated by Javadoc-IFramed"; // marker string, deliberately not localized
        if (timestamp) {

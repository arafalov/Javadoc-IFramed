...
public class TagletManager {
    ...
    private void checkTaglet(Object taglet) {
        ...
        } else if (taglet instanceof com.outerthoughts.javadoc.iframed.Taglet) {
            com.outerthoughts.javadoc.iframed.Taglet legacyTaglet = (com.outerthoughts.javadoc.iframed.Taglet) taglet;

...
public class TagletManager {
    ...
    private void checkTaglet(Object taglet) {
        ...
        } else if (taglet instanceof com.outerthoughts.html5doclet.Taglet) {
            com.outerthoughts.html5doclet.Taglet legacyTaglet = (com.outerthoughts.html5doclet.Taglet) taglet;
